...
})({"b5tXD":[function(require,module,exports) {
...
var _todoList = require("./resources/TodoList");
var _bulmaMinCss = require("bulma/css/bulma.min.css");
const todos = new (0, _todoList.TodoList)();
document.querySelector("form").addEventListener("submit", function(e) {
    e.preventDefault();
    console.log("submit");
    const formData = new FormData(e.target);
    const todo = {};
    for (const [key, val] of formData.entries())todo[key] = val;
    todos.addTodo(todo);
    todos.render();
//   this.reset();
});

},{"bulma/css/bulma.min.css":"1KKGO","./resources/TodoList":"8nvqM"}],"1KKGO":[function() {},{}],"8nvqM":[function(require,module,exports) {
...
class TodoList {
    ...
    render() {
        this.todos.forEach((todo)=>Array.from(this.rowsTodos).forEach((colTodo)=>{
...
},{}]},["b5tXD","bB7Pu"], "bB7Pu", "parcelRequire9ec0")
